        ...
        <div class="w-full max-w-[720px] mx-auto">
            ...
            <section class="max-w-[600px] mx-auto bg-surface border border-border rounded-2xl p-5 sm:p-7 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                <form action="{{ route('dashboard.habits.update', $habit) }}" method="POST">
                    ...
                    <button type="submit" class="w-full hover:cursor-pointer mt-2 inline-flex items-center justify-center gap-1.5 font-medium text-[1rem] leading-none px-5 py-3 rounded-xl transition-all duration-200 whitespace-nowrap bg-brand-blue text-white shadow-[0_2px_4px_rgba(0,113,227,0.2)] hover:bg-brand-blue-hover hover:shadow-[0_4px_8px_rgba(0,113,227,0.3)]">
                        Editar Hábito
                    </button>
